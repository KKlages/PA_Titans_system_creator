...
def generate_system(
    ...
    for i in range(num_additional_planets):
        ...
        planet = {
            ...
            "mass": 5000,
            "position_x": int(distance * random.choice([1, -1])),
            "position_y": int(distance * random.uniform(-0.5, 0.5)),
            "velocity_x": int(random.uniform(-100, 100)),
            "velocity_y": int(random.uniform(80, 120)),
            "required_thrust_to_move": 0,
