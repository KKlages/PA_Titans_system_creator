...
1. Locate your PA Titans directory:
   - Windows: %LOCALAPPDATA%\\Uber Entertainment\\Planetary Annihilation\\
   - Linux: ~/.local/Uber Entertainment/Planetary Annihilation/
   - Mac: ~/Library/Application Support/Uber Entertainment/Planetary Annihilation/

2. Navigate to: server_mods/<your_mod_name>/ui/main_game/live_game/systems/
   (Create the directories if they don't exist)

3. Copy all .pas files from this archive into the systems folder

4. Launch PA Titans and your systems should be available in custom games!

## System Configuration

Each system contains:
- 2 equal starting planets (same size and metal)
- Additional resource planets with ±10% metal variance
- Balanced orbital positioning

Generated by: PA Titans System Generator
https://github.com/yourusername/pa-titans-system-generator
"""
